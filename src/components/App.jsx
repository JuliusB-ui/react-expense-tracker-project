export const App = () => {
  return (
    ...
    <main>
      ...
      <form>
        <div>
          <input type="radio" name="expense" id="exepenseradio1" />
          <label htmlFor="expenseradio1">Expense</label>
          <input type="radio" name="income" id="incomeradio1" />
          <label htmlFor="incomeradio1">Income</label>
        </div>
        <div>
          <label htmlFor="date">Date<input type="date" name="date" id="date1"/><span><a><svg></svg></a></span></label>
          <label htmlFor="time">Time<input type="time" name="time" id="time1" /><span><a><svg></svg></a></span></label>
        </div>
        <label htmlFor="category">Category <select name="category" id="category1"></select></label>
      </form>
    </main>
    </div>
  );
